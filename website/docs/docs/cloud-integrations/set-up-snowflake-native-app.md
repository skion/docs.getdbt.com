...
1. In dbt Cloud, browse to your Semantic Layer configurations. 
    1. Go to to the left hand side panel and click your account name. From there, select **Account settings** then, **Projects** and choose your dbt project from the project list. 
